      ...
      <article v-if="['series', 'movies', 'channels'].includes(safariPage)" class="safari-page safari-library-page">
        ...
        <div v-if="safariLibraryTab === 'channel' && liveTvChannels.length" class="live-tv-browser">
          ...
          <section class="live-tv-channel-list" aria-label="Live TV channels">
            <header class="live-tv-table-row"><span>Channel</span><span>Key</span><span>ID</span><span>Category ID</span><span>Category</span><span>Format</span><span>Duration</span><span>Rating</span><span>Added</span><span>Status</span></header>
